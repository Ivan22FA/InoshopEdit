      ...
      <section className="relative w-full bg-linear-to-br from-[#031A26] via-[#053B44] to-[#0A6C71] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-10 items-center relative z-10">
          ...
          <div className="relative w-full flex justify-center md:justify-end items-center mt-10 md:mt-0">
            <div className="relative w-[320px] h-[220px] sm:w-[500px] sm:h-[320px] md:w-[760px] md:h-[480px]">
              {/* BACK LAYER */}
              ...
              {/* MIDDLE LAYER */}
              <div className="absolute right-4 top-4 w-[260px] h-[160px] sm:w-[460px] sm:h-[260px] md:w-[560px] md:h-80 transform rotate-1 rounded-2xl overflow-hidden shadow-2xl border border-white/8">
                <Image
              ...
              {/* FRONT LAYER */}
              <div className="absolute left-1/2 -translate-x-1/2 -bottom-2 w-[280px] h-[160px] sm:w-[480px] sm:h-[260px] md:w-[620px] md:h-[350px] transform translate-y-0 rounded-3xl overflow-hidden shadow-2xl border border-white/10 bg-white">
                <Image
